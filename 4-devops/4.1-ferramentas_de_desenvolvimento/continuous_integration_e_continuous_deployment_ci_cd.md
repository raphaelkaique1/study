...
1. **PROVISION**<br/>
O provisionamento nada mais é do que a criação do ambiente básico de hospedagem.
2. **DEPLOY**<br/>
A disponibilização é quando o software e suas atualizações são enviados para o ambiente de hospedagem.
