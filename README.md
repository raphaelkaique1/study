...
* **<a href="https://github.com/raphaelkaique1/study/blob/main/1-fundamentos_de_computacao/1.1-conceitos_basicos/algoritmos.txt">Algoritmos</a>**
...
* **<a href="https://github.com/raphaelkaique1/study/blob/main/1-fundamentos_de_computacao/1.2-hardware_e_software/conhecimentos_de_prompt_de_comando_e_terminal.sh">Conhecimentos de Prompt de Comando/Terminal</a>**
...
## <a href="https://github.com/raphaelkaique1/study/tree/main/2-desenvolvimento_web">2. Desenvolvimento Web</a>
### 2.1 Fundamentos da Web
...
### <a href="https://github.com/raphaelkaique1/study/tree/main/2-desenvolvimento_web/2.4-ferramentas_de_desenvolvimento">2.4 Ferramentas de Desenvolvimento</a>
* **<a href="https://github.com/raphaelkaique1/study/blob/main/2-desenvolvimento_web/2.4-ferramentas_de_desenvolvimento/controle_de_versao_git_github.sh">Controle de Versão (Git/GitHub)</a>**
...
## 3. Desenvolvimento de Software para Desktop
### 3.1 Introdução ao Desenvolvimento de Software para Desktop
...
### 3.2 Linguagens de Programação para Desktop
* **Java (JavaFX, Swing)**
...
### 3.3 Interface Gráfica do Usuário (GUI)
...
### 3.5 Desenvolvimento para IoT (Internet of Things)
...
### 3.6 SDK (Software Development Kit) e Ferramentas
* **Utilização de SDKs Específicos para Desenvolvimento Desktop**
...
### 3.7 Segurança em Aplicações Desktop
...
### 3.9 Desenvolvimento Multiplataforma
...
### 3.10 Projeto Prático de Desenvolvimento de Software para Desktop
* **Desenvolvimento de um Aplicativo Prático**
  - Escolha e planejamento do projeto prático.
  - Implementação de uma aplicação desktop completa.

* **Aplicação dos Conhecimentos Adquiridos**
  - Aplicação prática dos conceitos estudados ao longo do curso.
  - Apresentação e documentação do projeto.

## 4. Exploração Avançada em IoT e SDK
### 4.1 Desenvolvimento Avançado para IoT
...
### 4.2 SDKs Específicos
* **Exploração de SDKs para Desenvolvimento Específico de Desktop**
  - Estudo de SDKs específicos para o desenvolvimento desktop.
...
### 5.2 JavaScript
* **Sintaxe e Funcionalidades ECMAScript 6+**
  - Características do ECMAScript 6 e posteriores.
...
* **HTTPS**
  ...
  - Adoção do HTTPS como prática padrão.

## <a href="https://github.com/raphaelkaique1/study/tree/main/8-desenvolvimento_avancado">8. Desenvolvimento Avançado</a>
### <a href="https://github.com/raphaelkaique1/study/tree/main/8-desenvolvimento_avancado/8.1-arquitetura_de_solucao">8.1 Arquitetura de Solução</a>
* **Padrões de Projeto (Design Patterns)**
  - Implementação de padrões como Singleton, Observer, Factory, etc.
  - Escolha adequada de padrões para cenários específicos.

* **Arquitetura de Software (Escalabilidade e Desempenho, Estratégias de Otimização, Caching)**
...
## 10. Especialização em JavaScript
...
## 12. Aprofundamento em Redes e Servidores
...
## 13. Projetos Avançados e Pesquisa
* **Desenvolvimento de Sistemas Distribuídos**
  - Arquitetura e implementação de sistemas distribuídos.
  - Resolução de desafios específicos de sistemas distribuídos.
