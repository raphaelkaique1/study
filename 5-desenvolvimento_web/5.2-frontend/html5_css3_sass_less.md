...
###### CABEÇALHO
 ...
 Neste caso, cada seção poderia possuir seu título envolto na tag `h1`, pois assim o conteúdo seria indexado pelos mecanismos de busca ao usuário pesquisar pelo produto `x`, ou pelo `y`, assim dando um maior alcance de público e visitar ao site.
