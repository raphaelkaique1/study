...
## URL
URLs seguem um padrão definido por [RFC 3986](https://datatracker.ietf.org/doc/html/rfc3986). Uma URL completa tem essa estrutura:
```xml
<protocolo>://<host>:<porta>/<caminho>?<query_string>#<fragmento>
```
...
- **Porta**: `443`
- **Caminho**: `/page`
- **Query String**: `name=Raphael&id=999`
...
**Uma URL ideal deve ser limpa, utilizar path params para conteúdo relevante e query strings para filtros.**
