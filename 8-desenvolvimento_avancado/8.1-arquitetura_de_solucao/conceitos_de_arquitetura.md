...
- **Fatores de desenvolvimento:**
  ...
  A dinâmica da empresa que trás mudanças constantes buscando o melhor pode trazer mudanças nas necessidades, turn-over do projeto (troca de colaboradores) e a ter maior preocupação com a tecnologia do que com o negócio, são pontos que devem ser observados com cautela por apresentarem risco ao processo de desenvolvimento.
 ...
 Quem são os responsáveis por realizar as tarefas? Conhecer a organização e a estrutura organizacional da empresa trás uma clareza sobre quem são os stakeholders (responsáveis por realizar determinada atividade) e quem são os usuários.
...
Em ambas é usado o cabeçalho, que trás a identificação do caso de uso:
<pre>
        ┌─────────────────────────────────────────────┐
        │                  ESTRUTURA                  │
        ├──────────────────────┬──────────────────────┤
...
<pre>
 ...
 Que busca:
  ...
  Ao buscar integração entre os setores, gera COLABORAÇÃO, que por sua vez trás agilidade ao processo. Assim alcançando a qualidade, por atender as expectativas do cliente dentro dos acordos negociados.<br/>
  Por que a colaboração é tão importante? A colaboração  trás vários benefícios para as empresas e seus processos (impactando positivamente diretamente sobre a qualidade do seu produto final):
