...
- **`scripts/`**: Exemplos de algoritmos escritos em diferentes linguagens, usadas para estudo de scripts e exercícios de lógica de programação, cobrindo desde conceitos básicos como sintaxe, variáveis, operadores e estrutura de dados até tópicos mais avançados, como orientação a objetos, desenvolvimento web orientado à eventos, tratamento de exceções e manipulação de arquivos. Os scripts aqui focam em estruturas de controle e organização básica de programas.

- **`projects/`**: Programas criados com base nos conhecimentos adquiridos para praticar o desenvolvimento e programação de softwares.
